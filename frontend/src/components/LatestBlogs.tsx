      ...
      <div className="flex flex-col">
        {data.map((item, id) => {
          return (
            <div
              key={id}
              className="flex flex-col gap-2 rounded-xl hover:bg-zinc-100 dark:hover:bg-zinc-800 p-4 cursor-pointer"
            >
              <h3 className="text-light-quaternary dark:text-dark-quaternary">
                {item.date}
              </h3>
              <h1 className="text-light-secondary dark:text-dark-secondary">
                {item.title}
              </h1>
              <p className="text-light-quaternary dark:text-dark-quaternary">
                {item.desc}
              </p>
            </div>
          );
