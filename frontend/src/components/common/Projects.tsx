...
const Project = ({ project }: { project: IProject }) => {
  return (
    <a
      ...
      className="flex flex-col cursor-pointer dark:hover:bg-[#18181a] hover:bg-[#fafafa] rounded-lg transition-colors duration-300 overflow-hidden"
    >
